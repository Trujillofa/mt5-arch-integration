...
| `source=mql5_export` requires report SHA-256 / size / mtime and a post-start exact symbol/period file | Proven (`test_stale_report_refuses`, `test_wrong_symbol_report_refuses`, `test_post_record_tamper_refuses`) |
