...
| Oil session scalp | `python3 scripts/oil_session_scalp_autoresearch.py` | `et_date < 2026-04-01` develop (lock). Not XAU `2026-01-01`, not index `2026-06-01`, not BTC `2026-03-01`. Rank develop-only. | Vantage `CL-OIL` M5 via Mt5ArchBridge `dump_history.request` stamped 2026-09-11 (p50 spread 30, slip 3, contract 1000, typical RT $36). Do **not** lock `M15.hc`, cTrader H1, Dukascopy LIGHT, or `CL=F`. | [HOWTO-OIL-SESSION-SCALP.md](../HOWTO-OIL-SESSION-SCALP.md). Overlay observe-only. |
