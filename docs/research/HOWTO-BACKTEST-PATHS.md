...
| BTC NY-desk overlap | `python3 scripts/btc_ny_session_scalp_autoresearch.py` | Select `et_date < 2026-03-01` (lock). **Assert ≠** XAU 2026-01-01 and ≠ index 2026-06-01. | 1 lot / point 0.01 / slip **160** / cap 2000. Typical RT ~$19 at median 1600-pt spread. | Design: [BTC-NY-SESSION-SCALP.md](BTC-NY-SESSION-SCALP.md). SCREEN_FAIL 0/96. Overlay observe-only. |
